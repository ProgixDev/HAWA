...
const PURPLE = '#6949BE';
const PURPLE_BRIGHT = '#7654E8';
const PURPLE_DARK = '#28166F';
const MUTED = '#776C92';
const SUCCESS = '#3FA372';

const HERO_PURPLE_SOFT = '#F4EDFF';
const HERO_PURPLE_PALE = '#FBF8FF';
        ...
        <View style={styles.ringShell}>
          <Svg height={RING_SIZE} width={RING_SIZE}>
            <Defs>
              <SvgLinearGradient id="menopauseRingGradient" x1="0%" x2="100%" y1="0%" y2="100%">
                ...
                <Stop offset="48%" stopColor="#7654E8" />
                <Stop offset="100%" stopColor="#5A35C4" />
              </SvgLinearGradient>
            </Defs>
          ...
          <View pointerEvents="none" style={styles.ringInner}>
            <View style={styles.ringIconBubble}>
              <MaterialDesignIcons
                color={progress >= 1 ? SUCCESS : PURPLE}
