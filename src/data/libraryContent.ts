...
export const LIBRARY_ARTICLES: LibraryArticle[] = [
  ...
  },
  {
    ...
    type: 'guide',
    durationMinutes: 7,
    tags: ['santé', 'bien-être', 'suivi', 'cycle', 'symptômes', 'consultation'],
    summary:
      'Pourquoi le cycle est parfois appelé le « cinquième signe vital ».',
    content: [
      'Le cycle menstruel reflète souvent l’équilibre général du corps ; observer sa durée, son flux, ses douleurs ou son ressenti aide à mieux te connaître.',
      'Il n’existe pas un seul cycle parfait : un cycle régulier se situe généralement entre 21 et 35 jours, avec de légères variations tout à fait normales.',
      'Certains changements méritent d’être surveillés (règles très abondantes, absence prolongée, douleurs inhabituelles), sans qu’un cycle isolé et différent signifie automatiquement un problème.',
      'Suivre son cycle dans la durée aide à repérer ses propres habitudes plutôt qu’à se comparer, et à savoir quand demander l’avis d’un professionnel de santé.',
    ],
  },
  // ------------------------------------------------------------ firstPeriod
  {
  ...
  {
    id: 'firstperiod-premiers-signes',
    title: 'Les premiers signes avant les règles',
    categoryId: 'firstPeriod',
    level: 'beginner',
    type: 'article',
    durationMinutes: 5,
    tags: ['premières règles', 'signes', 'puberté'],
    isNew: true,
    summary:
      'Changements corporels, pertes, humeur : les indices qui annoncent les premières règles.',
    content: [
      'Dans les mois qui précèdent les premières règles, le corps change doucement : silhouette, pilosité, transpiration.',
      'De légères pertes blanchâtres, une sensibilité des seins ou de petits tiraillements au ventre sont des signes fréquents.',
      'Ces signes restent des repères généraux, jamais une prédiction précise : chaque corps suit son propre rythme.',
    ],
  },
  {
    id: 'firstperiod-comment-savoir',
    ...
    tags: ['premières règles', 'signes', 'puberté'],
    summary:
      'Reconnaître les signes concrets, et savoir quand en parler à un adulte.',
    content: [
      'De légères pertes blanchâtres, une poitrine qui se développe ou de petits tiraillements annoncent souvent l’arrivée prochaine des règles.',
      'Les pertes vaginales sont claires et sans odeur marquée ; le sang menstruel a une couleur rouge à brunâtre.',
      'Il n’y a jamais de mauvais moment pour en parler à une personne de confiance ou à un professionnel de santé.',
    ],
  },
  {
    id: 'firstperiod-choisir-protection',
    title: 'Quelle protection choisir pour mes premières règles ?',
    categoryId: 'firstPeriod',
    level: 'beginner',
    type: 'guide',
    durationMinutes: 6,
    tags: ['premières règles', 'protection', 'hygiène'],
    summary:
      'Serviettes, culottes menstruelles, tampons : comprendre les options selon son confort.',
    content: [
      'Pour les premières règles, la serviette hygiénique est généralement la protection la plus simple à utiliser.',
      'Les culottes menstruelles et les tampons sont d’autres options à essayer plus tard, si l’on s’en sent l’envie.',
      'Il n’y a pas de bonne ou de mauvaise protection : le choix dépend du confort et des habitudes de chacune.',
    ],
  },
  {
    id: 'firstperiod-gerer-quotidien',
    title: 'Comment gérer ses premières règles au quotidien ?',
    categoryId: 'firstPeriod',
    level: 'beginner',
    type: 'guide',
    durationMinutes: 5,
    tags: ['premières règles', 'quotidien', 'école'],
    summary:
      'École, sport, sommeil : quelques habitudes simples pour rester à l’aise.',
    content: [
      'École, sport, sommeil : les règles n’empêchent pas de continuer ses activités habituelles.',
      'Une petite trousse de secours avec une protection, une culotte de rechange et des lingettes évite le stress d’être prise au dépourvu.',
      'Si les règles arrivent de façon inattendue, une infirmière scolaire, une enseignante ou une amie a presque toujours de quoi dépanner.',
    ],
  },
  {
    id: 'firstperiod-cycle-irregulier',
    title: 'Mes premières règles sont irrégulières : est-ce normal ?',
    categoryId: 'firstPeriod',
    level: 'beginner',
    type: 'guide',
    durationMinutes: 5,
    tags: ['premières règles', 'cycle', 'irrégularité'],
    summary:
      'Pourquoi le cycle met du temps à se stabiliser, et quand consulter.',
    content: [
      'Les hormones qui régulent le cycle mettent du temps à trouver leur équilibre : les cycles irréguliers sont fréquents au début.',
      'Le cycle peut mettre un à deux ans, parfois un peu plus, avant de devenir plus régulier.',
      'Un avis médical reste utile si les règles sont absentes pendant plusieurs mois après leur apparition, ou en cas de doute persistant.',
    ],
  },
  {
    id: 'firstperiod-questions-frequentes',
    title: 'Questions fréquentes sur les premières règles',
    categoryId: 'firstPeriod',
    level: 'beginner',
    type: 'faq',
    durationMinutes: 4,
    tags: ['premières règles', 'faq', 'questions'],
    summary:
      'Les réponses simples aux questions les plus courantes sur les premières règles.',
    content: [
      'Un flux léger ou plus abondant, de légères crampes : ces variations sont fréquentes lors des premiers cycles.',
      'Le sport et la baignade restent possibles pendant les règles, avec une protection adaptée.',
      'Il n’existe pas de question gênante : chaque corps est différent, et il est toujours possible d’en parler à une personne de confiance.',
    ],
  },
  // -------------------------------------------------------------------- flow
  {
  ...
  },
  {
    ...
    type: 'guide',
    durationMinutes: 4,
    tags: ['flux', 'règles', 'couleurs', 'textures'],
    phases: ['menstruation'],
    summary:
      'La couleur et la texture de tes règles en disent long sur ta santé hormonale.',
    content: [
      'La couleur du flux évolue naturellement au fil des règles : rouge vif en début de cycle, plus foncé ou marron en fin de règles, quand le sang est plus ancien.',
      'La texture peut aussi varier — fluide, crémeuse, avec de petits caillots — sans que cela soit systématiquement un signe de problème.',
      'Une couleur orange inhabituelle, une odeur forte ou des démangeaisons associées méritent en revanche d’être signalées à un professionnel de santé.',
    ],
  },
  // --------------------------------------------------------------- symptoms
  {
  ...
  // -------------------------------------------------------------- fertility
  {
    ...
    phases: ['fertile'],
    summary:
      'Pourquoi les 6 jours autour de l’ovulation comptent le plus pour concevoir.',
    content: [
  ...
  // ---------------------------------------------------------- conceptionTips
  {
    ...
    summary:
      'Les repères essentiels pour démarrer sereinement ton parcours de conception.',
    content: [
  ...
  },
  {
    ...
    summary: 'Des habitudes simples qui peuvent accompagner ton parcours, sans pression.',
    content: [
  ...
  // --------------------------------------------------------------------- pcos
  {
    ...
    isNew: true,
    summary:
      'Le syndrome des ovaires polykystiques, en clair : ce qu’il est, à quel point il varie d’une femme à l’autre, et où en savoir plus.',
    content: [
  ...
  {
    id: 'pcos-cycle-ovulation-fertilite',
    title: 'Cycle, ovulation et fertilité dans le SOPK',
    categoryId: 'pcos',
    level: 'intermediate',
    type: 'guide',
    durationMinutes: 6,
    tags: ['SOPK', 'ovulation', 'fertilité', 'cycle irrégulier'],
    isNew: true,
    summary:
      'Pourquoi le cycle devient irrégulier avec le SOPK, et ce que cela signifie pour la fertilité.',
    content: [
      'Un déséquilibre hormonal perturbe le développement des follicules, rendant les cycles longs ou imprévisibles.',
      'L’ovulation peut devenir rare ou absente certains mois, ce qui explique en partie l’irrégularité des cycles.',
      'Le SOPK peut compliquer une conception, sans la rendre impossible : de nombreuses femmes conçoivent naturellement ou avec un accompagnement adapté.',
    ],
  },
  {
    id: 'pcos-peau-pilosite-symptomes',
    title: 'Peau, pilosité et symptômes visibles du SOPK',
    categoryId: 'pcos',
    level: 'beginner',
    type: 'guide',
    durationMinutes: 6,
    tags: ['SOPK', 'acné', 'pilosité', 'peau'],
    isNew: true,
    summary:
      'Pourquoi le SOPK peut affecter la peau et la pilosité, et comment en prendre soin.',
    content: [
      'Un excès relatif d’androgènes agit sur les glandes sébacées et les follicules pileux.',
      'Acné hormonale, pilosité excessive (hirsutisme) et amincissement des cheveux sont des signes possibles, à des degrés variables.',
      'Des solutions esthétiques et médicales existent : un dermatologue ou un gynécologue peut orienter vers les options adaptées.',
    ],
  },
  {
    id: 'pcos-diagnostic-examens',
    title: 'Diagnostic du SOPK : examens et bilan',
    categoryId: 'pcos',
    level: 'intermediate',
    type: 'guide',
    durationMinutes: 6,
    tags: ['SOPK', 'diagnostic', 'bilan hormonal', 'échographie'],
    isNew: true,
    summary:
      'Comment le SOPK est diagnostiqué, et comment préparer ta consultation.',
    content: [
      'Le diagnostic combine généralement historique de cycles, examen clinique, prise de sang et parfois échographie.',
      'La prise de sang mesure certaines hormones et écarte d’autres causes possibles de cycles irréguliers.',
      'Un aspect polykystique isolé à l’échographie, sans autre signe, ne suffit pas à poser un diagnostic de SOPK.',
    ],
  },
  {
    id: 'pcos-poids-metabolisme-insuline',
    title: 'Poids, métabolisme et résistance à l’insuline',
    categoryId: 'pcos',
    level: 'intermediate',
    type: 'guide',
    durationMinutes: 6,
    tags: ['SOPK', 'insuline', 'poids', 'métabolisme'],
    isNew: true,
    summary:
      'Le lien entre SOPK, poids et résistance à l’insuline, sans jugement ni raccourci.',
    content: [
      'Le SOPK est souvent associé à une tendance à stocker les graisses au niveau abdominal et à une résistance à l’insuline.',
      'L’excès d’insuline qui en résulte peut stimuler la production d’androgènes par les ovaires.',
      'Le SOPK touche des femmes de toutes corpulences ; le poids n’est qu’une partie du tableau métabolique.',
    ],
  },
  {
    id: 'pcos-mode-de-vie-prise-en-charge',
    title: 'Mode de vie et prise en charge du SOPK',
    categoryId: 'pcos',
    level: 'beginner',
    type: 'guide',
    durationMinutes: 7,
    tags: ['SOPK', 'mode de vie', 'nutrition', 'bien-être'],
    isNew: true,
    summary:
      'Les options de prise en charge du SOPK, et des habitudes simples pour accompagner ton quotidien.',
    content: [
      'La prise en charge du SOPK est adaptée à chaque situation : hygiène de vie, traitements hormonaux ou autres options selon les besoins.',
      'Alimentation équilibrée, activité physique régulière et sommeil suffisant soutiennent l’équilibre hormonal et métabolique.',
      'Le bien-être émotionnel fait pleinement partie de la prise en charge : ces symptômes peuvent peser sur le moral, et il est légitime d’en parler.',
    ],
  },
  {
    id: 'pcos-acne-hormonale',
    title: 'Comprendre l’acné hormonale',
    categoryId: 'pcos',
    level: 'beginner',
    type: 'guide',
    durationMinutes: 7,
    tags: ['SOPK', 'acné', 'androgènes', 'peau'],
    isNew: true,
    summary:
    ...
    content: [
      'L’acné hormonale est liée aux fluctuations des androgènes, qui stimulent les glandes sébacées ; elle touche souvent le bas du visage et persiste au-delà de l’adolescence.',
      'Elle peut s’aggraver dans les jours précédant les règles, quand la progestérone chute et stimule temporairement la production de sébum.',
      'Des soins doux au quotidien aident à la limiter, et un dermatologue ou un gynécologue peut proposer un traitement local ou hormonal si elle persiste, est douloureuse ou laisse des marques.',
    ],
  },
  // ----------------------------------------------------------------- hormones
  {
    ...
    summary:
      'Œstrogènes, progestérone, FSH, LH : comment elles évoluent et pourquoi les symptômes varient.',
    content: [
  ...
  // ---------------------------------------------------------------- exercise
  {
    ...
    type: 'guide',
    durationMinutes: 8,
    tags: ['exercice', 'SOPK', 'insuline', 'cycle'],
    summary:
      'Pourquoi bouger régulièrement peut soutenir ton cycle, quel type d’activité choisir, et comment adapter ton rythme sans pression.',
    content: [
  ...
  // ================================================================
  {
    ...
    type: 'guide',
    durationMinutes: 7,
    tags: ['fiqh', 'femme', 'introduction', 'madhab', 'pureté'],
    summary:
      'Un aperçu complet des grands sujets du fiqh féminin, entre pratique religieuse et vie quotidienne.',
    content: [
  ...
  },
  {
    ...
    type: 'guide',
    durationMinutes: 6,
    tags: ['pureté', 'règles', 'ghusl', 'tahara'],
    summary:
      'Comprendre le lien entre le cycle et l’état de pureté rituelle, pour aborder cette période avec plus de clarté.',
    content: [
  ...
  },
  {
    ...
    summary:
      'Distinguer un saignement irrégulier des règles habituelles, avec des repères généraux pour t’orienter.',
    content: [
...
},
  {
    ...
    type: 'guide',
    durationMinutes: 6,
    tags: ['ramadan', 'jeûne', 'règles', 'qadaa'],
    isNew: true,
    summary:
      'Conseils pratiques et repères éducatifs pour vivre le mois de Ramadan en période de règles, avec sérénité.',
    content: [
  ...
  },
  {
    ...
    summary:
      'Comment et quand rattraper les jours de jeûne manqués, à son propre rythme et sans culpabilité.',
    content: [
  ...
  },
  {
    ...
    summary:
      'Pourquoi la prière rituelle est suspendue durant cette période, et comment vivre ce moment avec sérénité.',
    content: [
  ...
  },
  {
    ...
    summary:
      'Les étapes générales pour reprendre la prière après les règles, avec sérénité.',
    content: [
  ...
  },
  {
    ...
    summary:
      'Les interrogations les plus posées sur le fiqh féminin, réunies en un endroit avec des réponses claires.',
    content: [
  ...
  },
  {
    ...
    summary:
      'Ce que la tradition évoque au sujet du deuil périnatal, avec douceur et bienveillance.',
    content: [
