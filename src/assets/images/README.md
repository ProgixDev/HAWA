...
- `hawa-logo.png` : logo transparent utilisé par le Splash Screen.
...
- `location-target.png` : icône GPS transparente.
- `hawa-splash-reference.png` : référence visuelle uniquement.

Le nom et la casse doivent rester strictement identiques.
