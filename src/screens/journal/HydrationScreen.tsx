      ...
      <ScrollView
        ...
        <Animated.View entering={FadeIn.duration(320)} style={styles.header}>
          ...
          <Pressable
            ...
            <MaterialDesignIcons color={PURPLE} name="cog-outline" size={23} />
          </Pressable>
        </Animated.View>
          ...
          <Animated.View style={[styles.addButtonWrap, buttonAnimatedStyle]}>
            <Pressable
              ...
              <LinearGradient
                ...
                <MaterialDesignIcons color="#FFFFFF" name="plus" size={22} />
...
const styles = StyleSheet.create({
  ...
  title: {color: PURPLE_DARK, fontFamily: 'serif', fontSize: 24, fontWeight: '700', textAlign: 'center'},
  ...
  flexCopy: {flex: 1},
  cardTitle: {color: PURPLE_DARK, fontSize: 15, fontWeight: '700'},
  goalValue: {marginTop: 5, color: PURPLE_DARK, fontFamily: 'serif', fontSize: 27, fontWeight: '700'},
  personalizeButton: {borderRadius: 18, backgroundColor: '#F1E9FF', paddingHorizontal: 12, paddingVertical: 8},
  personalizeText: {color: PURPLE, fontSize: 11, fontWeight: '700'},
  ...
  dropGlow: {backgroundColor: 'rgba(109,74,232,0.07)'},
  counter: {marginTop: 8, color: TEXT_MUTED, fontSize: 12, fontWeight: '600', textAlign: 'center'},
  success: {marginTop: 6, color: '#4D9B72', fontSize: 12, fontWeight: '700', textAlign: 'center'},
  addButtonWrap: {marginTop: 14, borderRadius: 16, shadowColor: '#5A36C8', shadowOffset: {width: 0, height: 5}, shadowOpacity: 0.22, shadowRadius: 9, elevation: 4},
  ...
  addText: {color: '#FFFFFF', fontSize: 15.5, fontWeight: '700'},
  feedbackFlash: {...StyleSheet.absoluteFillObject, backgroundColor: '#FFFFFF'},
  historyCard: {
    borderWidth: 1,
  ...
  moreText: {color: PURPLE, fontSize: 11, fontWeight: '700'},
  ...
  axisText: {color: '#A39AB8', fontSize: 8.5},
  barsRow: {flex: 1, flexDirection: 'row', alignItems: 'stretch', borderBottomWidth: StyleSheet.hairlineWidth, borderBottomColor: '#EDE7F6'},
  barColumn: {flex: 1, alignItems: 'center'},
  barTrack: {flex: 1, width: '48%', justifyContent: 'flex-end'},
  bar: {width: '100%', borderRadius: 9, backgroundColor: '#B99BF3'},
  barCurrent: {backgroundColor: PURPLE},
  dayLabel: {marginTop: 6, color: '#8C83A2', fontSize: 9, textAlign: 'center'},
  dayLabelCurrent: {color: PURPLE, fontWeight: '700'},
  adviceCard: {
    flexDirection: 'row',
    alignItems: 'center',
    borderRadius: 22,
  ...
  adviceTitle: {color: PURPLE_DARK, fontSize: 14, fontWeight: '700'},
  adviceText: {marginTop: 5, color: TEXT_MUTED, fontSize: 11.5, lineHeight: 17},
  ...
  sheet: {borderTopLeftRadius: 28, borderTopRightRadius: 28, backgroundColor: '#FFFFFF', paddingHorizontal: 20, paddingTop: 10},
  sheetHandle: {alignSelf: 'center', width: '14%', aspectRatio: 8, borderRadius: 999, backgroundColor: '#DDD4EB'},
  sheetTitle: {marginTop: 18, color: PURPLE_DARK, fontFamily: 'serif', fontSize: 22, fontWeight: '700', textAlign: 'center'},
  sheetSubtitle: {marginTop: 6, color: TEXT_MUTED, fontSize: 12.5, lineHeight: 18, textAlign: 'center'},
  goalOptions: {flexDirection: 'row', flexWrap: 'wrap', justifyContent: 'center', gap: 8, marginTop: 18},
  goalOption: {flexBasis: '29%', flexGrow: 1, alignItems: 'center', borderWidth: 1, borderColor: '#E2D8F0', borderRadius: 18, backgroundColor: '#FAF7FE', paddingHorizontal: 8, paddingVertical: 12},
  goalOptionSelected: {borderColor: PURPLE, backgroundColor: '#EEE5FF'},
  goalOptionText: {color: TEXT_MUTED, fontSize: 13, fontWeight: '600'},
  goalOptionTextSelected: {color: PURPLE, fontWeight: '700'},
  customLabel: {marginTop: 18, color: PURPLE_DARK, fontSize: 13, fontWeight: '700'},
  customInput: {marginTop: 8, borderWidth: 1, borderColor: '#DFD4EF', borderRadius: 16, backgroundColor: '#FCFAFF', paddingHorizontal: 14, paddingVertical: 12, color: PURPLE_DARK, fontSize: 15},
  sheetSave: {alignItems: 'center', marginTop: 16, borderRadius: 17, backgroundColor: PURPLE, paddingHorizontal: 16, paddingVertical: 15},
