...
// Same generic onboarding background/palette as ObjectiveScreen and
// CycleInformationScreen (the screen this one replaces, for Postpartum
// only) — no new visual identity introduced.
