...
// Same generic onboarding background/palette as ObjectiveScreen and the
// Postpartum onboarding screens this one is modeled after (see
// PostpartumDeliveryDateScreen.tsx) — no new visual identity introduced.
