...
function IconCircle({
  ...
  return (
    <View
      style={[
        styles.iconCircle,
        {backgroundColor: tint, borderRadius: Math.round(size * 0.36), height: size, width: size},
      ]}>
      <MaterialDesignIcons color={color} name={icon} size={Math.round(size * 0.48)} />
    </View>
  );
}
...
function InformativePanel({
  ...
  return (
    <View style={[styles.infoPanel, {backgroundColor: tint}]}> 
      <IconCircle color={accent} icon={icon} size={40} tint="rgba(255,255,255,0.72)" />
      ...
      <JournalCard>
        ...
        <View style={styles.durationRow}>
          <Pressable
            ...
            <MaterialDesignIcons color={homeColors.primary} name="minus" size={25} />
          </Pressable>
          ...
          <Pressable
            ...
            onPress={() => adjustSleep(0.5)}
            style={({pressed}) => [styles.stepButton, pressed && styles.pressed]}>
            <MaterialDesignIcons color={homeColors.primary} name="plus" size={25} />
          </Pressable>
        </View>
      ...
      <JournalCard>
        ...
        <View style={styles.subsection}>
          ...
          <View accessibilityLabel={`Date du prélèvement : ${todayLabel()}`} style={styles.dateField}>
            ...
            <MaterialDesignIcons color={homeColors.primary} name="chevron-down" size={20} />
          </View>
        </View>
      </JournalCard>
          ...
          <View style={styles.recordsList}>
            {labResultsHistory.slice(0, 5).map(result => (
              <View key={result.id} style={styles.recordRow}>
                ...
                <MaterialDesignIcons color={homeColors.textSecondary} name="chevron-right" size={20} />
              </View>
            ))}
          </View>
        </JournalCard>
      ...
      <JournalCard>
        <View style={styles.notesHeadingRow}>
          ...
          <View style={styles.datePill}>
            <MaterialDesignIcons color={homeColors.primary} name="calendar-outline" size={15} />
        ...
        <View style={styles.inspirationGrid}>
          {[
            ...
            <Pressable
              ...
              <MaterialDesignIcons color={homeColors.primary} name={icon as IconName} size={18} />
      ...
      <KeyboardAvoidingView
        ...
        <View style={[styles.topBar, {paddingTop: getTopPadding(insets.top, true)}]}>
          <Pressable
            ...
            <MaterialDesignIcons color={homeColors.primaryDark} name="chevron-left" size={24} />
          </Pressable>
        </View>
          ...
          <FadeIn>
              ...
              {!compact ? (
                <>
                  <View pointerEvents="none" style={styles.heroLeafLeft}>
                    <MaterialDesignIcons color="rgba(109,74,232,0.13)" name="leaf" size={72} />
                  </View>
                  <View pointerEvents="none" style={styles.heroLeafRight}>
                    <MaterialDesignIcons color="rgba(220,123,130,0.13)" name="flower-outline" size={68} />
                  </View>
                </>
              ) : null}
            ...
            {error ? (
              <View style={styles.errorCard}>
                <MaterialDesignIcons color="#B04C64" name="alert-circle-outline" size={18} />
            ...
            <Pressable
              ...
              <MaterialDesignIcons color="#FFFFFF" name={saving ? 'loading' : 'lock-outline'} size={22} />
...
const styles = StyleSheet.create({
  ...
  journalCard: {
    overflow: 'hidden',
    borderWidth: 1,
    borderColor: 'rgba(109,74,232,0.095)',
    borderRadius: 18,
  ...
  optionCard: {
    ...
    justifyContent: 'center',
    borderWidth: 1,
    borderColor: 'rgba(109,74,232,0.12)',
    borderRadius: 17,
  ...
  selectionMark: {
    ...
    justifyContent: 'center',
    borderWidth: 1.4,
    borderColor: 'rgba(126,112,166,0.25)',
    borderRadius: 10,
  ...
  stepButton: {
    ...
    justifyContent: 'center',
    borderWidth: 1,
    borderColor: 'rgba(109,74,232,0.14)',
    borderRadius: 14,
  ...
  textAreaWrap: {
    ...
    overflow: 'hidden',
    borderWidth: 1,
    borderColor: 'rgba(109,74,232,0.13)',
    borderRadius: 15,
  ...
  labValueField: {
    borderColor: 'rgba(109,74,232,0.50)',
  },
  ...
  recordRow: {
    ...
    paddingVertical: 7,
    borderBottomWidth: 1,
    borderBottomColor: 'rgba(109,74,232,0.08)',
  },
  ...
  privacyFooter: {
    ...
    borderColor: 'rgba(109,74,232,0.07)',
    borderRadius: 14,
    backgroundColor: 'rgba(250,246,255,0.72)',
    paddingVertical: 8,
