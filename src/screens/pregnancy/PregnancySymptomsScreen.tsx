            ...
            <View style={styles.card}>
              <View style={styles.symptomsHeader}>
                <View style={styles.headingIcon}>
                  <MaterialDesignIcons color={homeColors.primary} name="clipboard-pulse-outline" size={18} />
                </View>
                ...
                <View style={styles.countBadge}>
                  <MaterialDesignIcons color={homeColors.primary} name="check-circle-outline" size={14} />
                  ...
                  return (
                    <Pressable
                      ...
                      <View style={[styles.symptomIconContainer, active && styles.symptomIconContainerActive]}>
                        <MaterialDesignIcons color={active ? '#FFFFFF' : homeColors.primary} name={SYMPTOM_ICONS[item]} size={20} />
                      </View>
                      ...
                      <View style={[styles.selectionIndicator, active && styles.selectionIndicatorActive]}>
                        <MaterialDesignIcons color={active ? '#FFFFFF' : '#A79BBB'} name={active ? 'check' : 'plus'} size={14} />
                      </View>
                    </Pressable>
                  );
                })}
...
const styles = StyleSheet.create({
  ...
  roundButton: {width: 42, height: 42, alignItems: 'center', justifyContent: 'center', borderWidth: 1, borderColor: '#E6DDEE', borderRadius: 18, backgroundColor: '#FFFFFF'},
  checkButton: {borderWidth: 0, backgroundColor: homeColors.primary, elevation: 2},
  ...
  hero: {height: 115, justifyContent: 'center', overflow: 'hidden', borderWidth: 1, borderColor: '#E2D8F0', borderRadius: 20, backgroundColor: '#FCF8FF'},
  heroImage: {borderRadius: 20},
  heroCopy: {width: '58%', paddingLeft: 28},
  heroTitle: {color: PURPLE_DARK, fontFamily: 'serif', fontSize: 20, fontWeight: '700'},
  heroSubtitle: {marginTop: 7, color: TEXT_SECONDARY, fontSize: 11.5, lineHeight: 16},
  ...
  headingIcon: {width: 30, height: 30, alignItems: 'center', justifyContent: 'center', borderRadius: 15, backgroundColor: '#EEE3FA'},
  headingCopy: {marginTop: 9},
  sectionTitle: {color: PURPLE_DARK, fontFamily: 'serif', fontSize: 15.5, fontWeight: '700'},
  sectionTitleStandalone: {color: PURPLE_DARK, fontFamily: 'serif', fontSize: 14, fontWeight: '700'},
  sectionSubtitle: {marginTop: 3, color: TEXT_SECONDARY, fontSize: 10.5, lineHeight: 14},
  ...
  countBadgeText: {color: ACTIVE_PURPLE, fontSize: 10.5, fontWeight: '700'},
  ...
  symptomRowActive: {borderColor: '#BCA8DF', backgroundColor: '#F4ECFB', shadowColor: ACTIVE_PURPLE, shadowOpacity: 0.1, shadowRadius: 7, elevation: 2},
  pressedRow: {opacity: 0.82, transform: [{scale: 0.992}]},
  symptomIconContainer: {width: 44, height: 44, flexShrink: 0, alignItems: 'center', justifyContent: 'center', borderRadius: 15, backgroundColor: '#F0E8F8'},
  symptomIconContainerActive: {backgroundColor: ACTIVE_PURPLE},
  symptomCopy: {flex: 1, minWidth: 0, marginHorizontal: 11},
  symptomText: {color: '#34285C', fontSize: 12.5, lineHeight: 17, fontWeight: '700', flexShrink: 1},
  symptomTextActive: {color: '#39256E', fontWeight: '800'},
  symptomHelperText: {marginTop: 3, color: '#897DA1', fontSize: 9.5, lineHeight: 13},
  symptomHelperTextActive: {color: '#6D56A0', fontWeight: '600'},
  selectionIndicator: {width: 28, height: 28, flexShrink: 0, alignItems: 'center', justifyContent: 'center', borderWidth: 1.5, borderColor: '#DDD3EA', borderRadius: 14, backgroundColor: '#FFFFFF'},
  selectionIndicatorActive: {borderColor: ACTIVE_PURPLE, backgroundColor: ACTIVE_PURPLE},

  noteBox: {minHeight: 120, marginTop: 8, borderWidth: 1, borderColor: '#E8DFF5', borderRadius: 13, backgroundColor: '#FCFAFF'},
  noteInput: {flex: 1, padding: 10, paddingBottom: 20, color: '#3D3560', fontSize: 10.5},
  counter: {position: 'absolute', right: 8, bottom: 6, color: '#8F84AC', fontSize: 8.5},
