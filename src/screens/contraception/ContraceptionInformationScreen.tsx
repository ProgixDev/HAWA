      ...
      <View style={styles.safeArea}>
        ...
        <ScrollView
          ...
          <View style={styles.header}>
            <View style={styles.heroIcon}>
              ...
              <LinearGradient
                ...
                <MaterialDesignIcons color={PURPLE} name="clipboard-text-outline" size={30} />
              </LinearGradient>
            </View>
          ...
          <View style={[styles.card, styles.cardSpaced]}>
            <View style={styles.fieldLabelRow}>
              <View style={styles.fieldIcon}>
                <MaterialDesignIcons color={PURPLE} name={TREATMENT_BREAK_ICON} size={16} />
              </View>
...
const styles = StyleSheet.create({
  ...
  card: {
    padding: 15, borderWidth: 1, borderColor: 'rgba(111,83,190,0.14)', borderRadius: 20,
  ...
  fieldIcon: {
    ...
    borderRadius: 10, backgroundColor: PURPLE_SOFT,
  },
  fieldLabel: {flex: 1, color: '#291D4E', fontSize: 13.5, fontWeight: '700', lineHeight: 18},
  dateField: {
    minHeight: 50, marginTop: 12, flexDirection: 'row', alignItems: 'center',
    paddingHorizontal: 12, borderWidth: 1, borderColor: '#DDD1EF', borderRadius: 15, backgroundColor: '#FFFFFF',
  },
  dateFieldValue: {flex: 1, color: '#2A2050', fontSize: 14, fontWeight: '700'},
  dateFieldPlaceholder: {flex: 1, color: '#948BB0', fontSize: 14},

  choiceRow: {marginTop: 12, flexDirection: 'row', gap: 10},
  choiceOption: {
    flex: 1, minHeight: 48, alignItems: 'center', justifyContent: 'center',
    borderWidth: 1.25, borderColor: 'rgba(111,83,190,0.20)', borderRadius: 15,
    backgroundColor: PURPLE_SOFT,
  },
  choiceOptionSelected: {borderColor: PURPLE, backgroundColor: PURPLE},
  choiceText: {color: PURPLE_DARK, fontSize: 14, fontWeight: '700'},
  ...
  nextButton: {
    ...
    gap: 8, marginTop: 12, borderRadius: 20, backgroundColor: PURPLE,
