...
// against it, so its colors stay fixed rather than becoming theme-driven
// (Phase E4 is visual-only; see CLAUDE.md §2/§6).
const SLEEP_HERO_FALLBACK_BG = '#E9D8F5';
const SLEEP_HERO_TITLE_COLOR = '#271563';
const SLEEP_HERO_TEXT_COLOR = '#30205E';
...
function createStyles(theme: ResolvedAwaTheme) {
  ...
  // Category E — fixed visual island (see SLEEP_HERO_* constants above):
  // this hero uses a real illustration image with calibrated overlay text,
  // so it stays untouched by theming.
  hero: {
    height: 150,
    justifyContent: 'center',
    overflow: 'hidden',
    borderRadius: 18,
    backgroundColor: SLEEP_HERO_FALLBACK_BG,
  },
  ...
  sheetHeader: {
    ...
    alignItems: 'center',
    borderBottomWidth: 1,
    borderBottomColor: withAlpha(theme.colors.primary, 0.14),
  },
