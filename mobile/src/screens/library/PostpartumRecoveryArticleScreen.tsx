...
const styles = StyleSheet.create({
  ...
  tipNumberText: {fontSize: 10, color: ROSE, fontWeight: '800'},
  tipRowText: {
    flex: 1,
    marginLeft: 10,
    paddingTop: 2,
  ...
  timelineNumber: {fontSize: 11, color: ROSE, fontWeight: '800'},
  timelineCopy: {flex: 1, marginLeft: 11},
  timelineTitle: {fontSize: 12.5, color: INK, fontWeight: '800'},
  timelineText: {
    marginTop: 3,
    fontSize: 11.5,
    lineHeight: 17,
  ...
  consultTitle: {fontSize: 13, color: INK, fontWeight: '800'},
  consultText: {
    marginTop: 4,
    fontSize: 11.5,
    lineHeight: 17,
  ...
  questionNumber: {fontSize: 10, color: ROSE, fontWeight: '800'},
  questionText: {
    flex: 1,
    marginLeft: 9,
    paddingTop: 2,
